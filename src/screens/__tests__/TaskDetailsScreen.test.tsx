...
describe('TaskDetailsScreen', () => {
  ...
  it('should update task when form is submitted', async () => {
    ...
    fireEvent.press(getByText('tasks.editTask'));
    fireEvent.changeText(getByPlaceholderText('tasks.taskTitle'), 'Updated Task');
    fireEvent.changeText(getByPlaceholderText('tasks.taskDescription'), 'Updated Description');
