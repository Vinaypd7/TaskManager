...
const translations = {
  en: {
    ...
    profile: {
      ...
      errorLogsDescription:
        "View and manage application error logs from all users",
      ...
      darkModeNotImplemented:
        "Dark mode feature is enabled but not implemented in this demo",
  ...
  es: {
    ...
    errors: {
      ...
      clear: "Limpiar",
      clearConfirmation:
        "¿Estás seguro de que quieres limpiar todos los registros de errores?",
    ...
    profile: {
      ...
      errorLogsDescription:
        "Ver y gestionar registros de errores de la aplicación de todos los usuarios",
      userManagementDescription:
        "Gestionar cuentas de usuario y permisos (Próximamente)",
      viewErrorLogs: "Ver Registros de Error",
      development: "Desarrollo",
      logoutError: "Error al cerrar sesión",
      languageChangeError: "Error al cambiar el idioma",
      darkModeNotImplemented:
        "La función de modo oscuro está habilitada pero no implementada en esta demo",
      copyright: "Task Manager App © 2025",
    },
  },
};
